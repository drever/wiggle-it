...
//    }
//    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"WiggleIt" withExtension:@"momd"];
...
//    }
//    
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"WiggleIt.sqlite"];
//    
//    NSError *error = nil;
